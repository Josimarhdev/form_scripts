...
try:
    from scripts.lib_integracao import export_query_to_csv, processar_e_salvar_excel
except ImportError:
    from lib_integracao import export_query_to_csv, processar_e_salvar_excel

print(">>> Iniciando Integração: Banco de Dados -> Excel")
