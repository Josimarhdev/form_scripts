...
excel_file_input = "/home/josimar/Documentos/planilhas/form2/planilhas_consumo/form2.xlsx"
planilhas_auxiliares = {
    "belem": "/home/josimar/Documentos/planilhas/form2/planilhas_consumo/belem.xlsx",
    "expansao": "/home/josimar/Documentos/planilhas/form2/planilhas_consumo/expansao.xlsx",
    "grs": "/home/josimar/Documentos/planilhas/form2/planilhas_consumo/GRS.xlsx"
}
...
for row in ws_input.iter_rows(min_row=2, values_only=True):
    ...
    if municipio_uvr_normalizado in dados_atualizados:
        ...
        dados_atualizados[municipio_uvr_normalizado] = {"datas": [data_envio_formatada], "status": "Enviado"}
        print('else')
...
for nome, caminho in planilhas_auxiliares.items():
    ...
    novo_caminho = f"/home/josimar/Documentos/planilhas/form2/{nome}_atualizado_form2.xlsx"
